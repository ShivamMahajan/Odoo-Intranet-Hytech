...
class sale_order(osv.osv):
    ...
    _columns = {
        ...
        'engagement_type':fields.selection([ ('fixed_budgets','Fixed Budgets'), ('time_materials','Time and Materials'),('resources','Resources') ],'Engagement Type', select=True, required=True, help="Select Enagement Type to define type of project"),
        'employee_id': fields.many2one('hr.employee', 'Employee Related Salesperson', states={'draft': [('readonly', False)], 'sent': [('readonly', False)]}),
    }
    ...
    def on_change_user(self, cr, uid, ids, user_id, context=None):
        """ When changing the user, get the employee_id value. """
    ...
    def _prepare_invoice(self, cr, uid, order, lines, context=None):
        ...
        invoice_vals = {
            ...
            'change_request_type': order.change_request_type,
        }
...
class sale_order_line(osv.osv):
    ...
    _columns = {
        ...
        'product_id': fields.many2one('product.product', 'Milestones/Skill Set', domain=[('sale_ok', '=', True)], change_default=True, readonly=True, states={'draft': [('readonly', False)]}, ondelete='restrict'),
    ...
    def _prepare_order_line_invoice_line(self, cr, uid, line, account_id=False, context=None):
        ...
        if not line.invoiced:
            ...
            res = {
                ...
                'change_request_type' : line.order_id.change_request_type,
            }
