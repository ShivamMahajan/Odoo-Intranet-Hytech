...
class account_analytic_line(osv.osv):
   ...
   # @api.model
    def get_analytical_account_employee(self, cr, uid, id, context=None):
        ...
        return analytical_account_project
    ...
    _columns = {
        ...
        #'account_id_domain':fields.function(_get_analytical_account_employee,string="Analytical account domain",type="char"),
        'members': fields.many2many('res.users', 'analytic_project_member_rel', 'analytical_line_id', 'project_member_id', 'Project Members',
        ...
        'employee_analytic':fields.many2one('hr.employee','Employee Reference'),
